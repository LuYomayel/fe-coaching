import { ApiResponse, PaymentStatusData } from '@/types';
...
// Coach Home Page
const fetchClientsPaymentStatus = async (coachId: string): Promise<ApiResponse<PaymentStatusData[]>> => {
...
export {
  fetchCoachSubscription, // checked
  fetchCoachSubscriptionPlans, // checked
  fetchSubscriptionForStudent, // checked
  fetchSubscriptionDetails, // checked
  makePayment, // checked
  updateCoachSubscription, // checked
  assignSubscription, // checked
  createOrUpdateCoachPlan, // checked
  registerPayment, // checked
  cancelSubscription, // checked
  fetchClientsPaymentStatus // checked
};
