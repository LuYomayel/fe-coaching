...
const findAllWorkoutTemplatesByCoachId = async (coachId): Promise<ApiResponse<IWorkoutTemplate[]>> => {
  try {
...
const fetchTrainingCyclesTemplates = async (coachId): Promise<ApiResponse<ITrainingCycleTemplate[]>> => {
  try {
...
const fetchWorkoutInstanceTemplate = async (templateId): Promise<ApiResponse<IWorkoutInstanceTemplate>> => {
  try {
...
const fetchWorkoutInstance = async (planId): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
...
const fetchTrainingCyclesByClient = async (clientId): Promise<ApiResponse<CalendarEvents>> => {
  try {
    ...
    if (cycles.length === 0)
      return {
        data: { events: [], cycleOptions: [] },
        success: true,
        message: 'Training cycles fetched successfully',
        error: undefined
      };
    ...
    return {
      data: { events, cycleOptions: cycles },
      success: true,
      message: 'Training cycles fetched successfully',
      error: undefined
    };
...
const fetchTrainingSessionWithNoWeekByClientId = async (clientId): Promise<ApiResponse<ITrainingSession>> => {
  try {
...
const fetchTrainingCyclesForClientByUserId = async (userId): Promise<ApiResponse<ITrainingCycle[]>> => {
  try {
    console.log(userId);
...
const fetchTrainingCyclesByCoachId = async (coachId): Promise<ApiResponse<ITrainingCycle[]>> => {
  try {
...
const fetchTrainingCycleTemplateById = async (cycleId): Promise<ApiResponse<ITrainingCycleTemplate>> => {
  try {
...
const fetchDeletedWorkoutTemplatesByCoachId = async (coachId): Promise<ApiResponse<IWorkoutTemplate[]>> => {
  try {
...
const fetchWorkoutsByClientId = async (clientId): Promise<ApiResponse<IWorkoutInstance[]>> => {
  try {
...
const fetchAssignedWorkoutsForCycleDay = async (cycleId, dayNumber): Promise<ApiResponse<IWorkoutInstance[]>> => {
  try {
...
const fetchExcelViewByCycleAndDay = async (cycleId, dayNumber): Promise<ApiResponse<IWorkoutInstance[]>> => {
  try {
...
const createTrainingCycle = async (body): Promise<ApiResponse<ITrainingCycle>> => {
  try {
...
const updateStatusLocal = (workout: IWorkoutInstance, session: ITrainingSession) => {
  const now = new Date();
...
const updateExercisesInstace = async (exercises: IExercise[]): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
...
const verifyExerciseChanges = async (exerciseData: IExercise[]): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
...
const updatePlanName = async (planId: string, planName: string): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
...
const submitPlan = async (
  ...
  isEdit: boolean,
  isTemplate: boolean
): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
...
const updateTrainingCycle = async (cycleId: string, body: ITrainingCycle): Promise<ApiResponse<ITrainingCycle>> => {
  try {
    const response = await fetch(`${apiUrl}/workout/training-cycle-templates/cycleId/${cycleId}`, {
      method: 'PUT',
      headers: getAuthHeaders(),
...
const verifyTrainingCycleDeletion = async (cycleId: string): Promise<ApiResponse<ITrainingCycle>> => {
  try {
...
const createNewTrainingFromExcelView = async (plan: IWorkoutInstance): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
...
const unassignWorkoutFromClient = async (
  workoutsIds: string[],
  clientId: string
): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
...
const deleteWorkoutPlan = async (planId: string, isTemplate: boolean): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
...
const deletePlan = async (workoutInstanceId: string): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
...
const getRpeMethods = async (userId: string): Promise<ApiResponse<IRpeMethod[]>> => {
  try {
...
const getRpeMethodAssigned = async (clientId = -1, planId = -1, cycleId = -1): Promise<ApiResponse<IRpeMethod>> => {
  try {
...
const getRpeAssignments = async (userId: string): Promise<ApiResponse<IRpeMethod[]>> => {
  try {
...
const createOrUpdateRpeMethod = async (
  dialogMode: string,
  newRpe: IRpeMethod,
  userId: string
): Promise<ApiResponse<IRpeMethod>> => {
  try {
    const url =
      dialogMode === 'create'
...
const removeRpeAssignment = async (
  assignmentId: string,
  targetType: string,
  userId: string
): Promise<ApiResponse<IRpeMethod>> => {
...
const deleteRpe = async (rpeId: string, userId: string): Promise<ApiResponse<IRpeMethod>> => {
  try {
...
const deleteExercises = async (exercises: IExercise[]): Promise<ApiResponse<IExercise[]>> => {
  try {
...
const assignCycleTemplateToClient = async (payload: any): Promise<ApiResponse<ITrainingCycle>> => {
  try {
...
// Coach Home Page
const fetchLastTimeTrained = async (coachId: string): Promise<ApiResponse<LastTimeTrainedData[]>> => {
  try {
...
const fetchHowLongToFinishCycle = async (coachId: string): Promise<ApiResponse<HowLongToFinishCycleData[]>> => {
  try {
...
const fetchTrainingFrequency = async (coachId: string): Promise<ApiResponse<TrainingFrequencyData[]>> => {
  try {
...
const saveWorkoutChanges = async (payload: any): Promise<ApiResponse<ITrainingCycle>> => {
  try {
...
const updateWorkoutInstance = async (workoutInstanceId: string, body: any): Promise<ApiResponse<IWorkoutInstance>> => {
  try {
