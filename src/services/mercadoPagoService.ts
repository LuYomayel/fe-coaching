 ...
 */
export const createMercadoPagoPayment = async (paymentData: any): Promise<ApiResponse<any>> => {
  try {
 ...
 */
export const checkMercadoPagoPaymentStatus = async (paymentId: any): Promise<ApiResponse<any>> => {
  try {
 ...
 */
export const notifyBankTransfer = async (transferData: any, coachId: any): Promise<ApiResponse<any>> => {
  try {
 ...
 */
export const getCoachBankData = async (coachId: any): Promise<ApiResponse<any>> => {
  try {
 ...
 * @returns {Promise<Object>} - Respuesta del servidor
 */
export const updateCoachBankData = async (coachId: any, bankData: any): Promise<ApiResponse<any>> => {
  try {
    const response = await fetch(`${apiUrl}/payment/coach-bank-data/${coachId}`, {
      method: 'POST',
      headers: getAuthHeaders(),
