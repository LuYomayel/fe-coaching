import { ApiResponse, IClient, ICoach, ICoachPlan } from '../types/shared-types';
...
const registerCoach = async (body: any): Promise<ApiResponse<ICoach>> => {
  try {
...
const login = async (body: any): Promise<ApiResponse<ICoach>> => {
  try {
...
const fetchUser = async (userId: string): Promise<ApiResponse<ICoach>> => {
  try {
...
const fetchCoach = async (userId: string): Promise<ApiResponse<ICoach>> => {
  try {
...
const fetchClient = async (userId: string): Promise<ApiResponse<ICoach>> => {
  try {
...
const fetchClientByClientId = async (clientId: string): Promise<ApiResponse<IClient>> => {
  try {
...
const fetchCoachPlans = async (userId: string): Promise<ApiResponse<ICoachPlan[]>> => {
  try {
...
const fetchCoachStudents = async (userId: string): Promise<ApiResponse<IClient[]>> => {
  try {
...
const fetchMessages = async (coachId: string, clientId: string, page = 1): Promise<ApiResponse<ICoach>> => {
  try {
...
const markMessagesAsRead = async (senderId: string, receiverId: string): Promise<ApiResponse<ICoach>> => {
  const body = {
    senderId,
    receiverId
  };
...
const fetchClientsSubscribed = async (coachId: string): Promise<ApiResponse<ICoach>> => {
  try {
