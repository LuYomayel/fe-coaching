...
const AssignWorkoutToSessionDialog = ({ visible, onHide, sessionId, clientId, setRefreshKey, selectedDate }) => {
  ...
  const { coach } = useContext(UserContext) as UserContextType;
  const intl = useIntl();
  ...
  const handleCreateNew = () => {
    router.push(`/plans/create-and-assign?clientId=${clientId}&sessionDate=${selectedDate}&changeToTemplate=false`);
  };
