...
export default function StudentCalendar() {
  ...
  if (!userContext) {
    throw new Error('StudentCalendar must be used within a UserProvider');
  }
  ...
  const handleStartTrainingSession = (workoutInstanceId) => {
    router.push(`/plans/start-session/${workoutInstanceId}?isTraining=true&planId=${workoutInstanceId}`);
  };
