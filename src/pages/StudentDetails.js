    ...
    <div className="student-details-container">
      ...
      <div className='flex justify-content-between'>
        ...
        <div className='container'>
          ...
          <DataTable value={student.workouts.filter(plan => plan.status === 'pending')} paginator rows={5} className="assigned-plans-table">
          {/* <DataTable value={student.workouts} paginator rows={10} className="assigned-plans-table"> */}
          ...
          <DataTable value={student.workouts.filter(plan => plan.status === 'completed')} paginator rows={5} className="expired-plans-table">
            <Column field="planName" header="Plan Name" />
            <Column field="dateAssigned" header="Date Assigned" />
