const messages: Record<string, string> = {
  ...
  'coach.rpe.confirm.delete': '¿Estás seguro de que deseas eliminar este método de medición?',
  'coach.rpe.success.created': 'Método de medición creado exitosamente',
  'coach.rpe.success.updated': 'Método de medición actualizado exitosamente',
  'coach.rpe.success.deleted': 'Método de medición eliminado exitosamente',
  'coach.rpe.success.defaultChanged': 'Método por defecto actualizado exitosamente',
  ...
  'clientDashboard.buttons.unassign': 'Eliminar sesiones/ciclos',
  ...
  'plan.details.sessionInfo': 'Información de la sesión',
  'plan.details.editExercises': 'Editar ejercicios',
  ...
  'home.login.validation.emailRequired': 'El correo electrónico es obligatorio',
  'home.login.validation.emailInvalid': 'Ingresa un correo electrónico válido',
  'home.login.validation.passwordRequired': 'La contraseña es obligatoria',
  'home.login.error.generic': 'No pudimos iniciar sesión. Intenta nuevamente.',
  ...
  'home.signup.validation.emailRequired': 'El correo electrónico es obligatorio',
  ...
  'resetPassword.confirm.exit': 'Si salís ahora, tu contraseña no se cambiará. ¿Querés salir?',
  ...
  'coachProfileForm.trainingType': 'Especialidades',
  'coachProfileForm.selectTrainingTypes': 'Selecciona tus especialidades',
  'coachProfileForm.hasGym': 'Tengo acceso a un gimnasio/estudio',
  ...
  'coachProfileForm.freeTrial': 'Prueba gratuita · hasta 3 clientes',
  'coachProfileForm.paid': 'Plan profesional',
  'coachProfileForm.choosePlan': 'Elegir plan',
  'coachProfileForm.subscriptionPlan': 'Plan seleccionado',
  'coachProfileForm.plan': 'Plan',
  'coachProfileForm.price': 'Precio',
  'coachProfileForm.clients': 'clientes',
  'coachProfileForm.submit': 'Publicar perfil',
  'coachProfileForm.summary': 'Resumen del perfil',
  'coachProfileForm.success': 'Perfil actualizado',
  'coachProfileForm.success.message': 'Gracias por suscribirte, {name}. Te llevamos al panel principal.',
  'coachProfileForm.error': 'Algo salió mal',
  'coachProfileForm.error.noUser': 'Vuelve a iniciar sesión para completar tu perfil.',
  'coachProfileForm.error.missingToken': 'Falta el token de autenticación.',
  ...
  'coachProfileForm.step.confirmation': 'Revisión final',
  'coachProfileForm.confirmationMessage': 'Revisa toda la información antes de confirmar.',
  'coachProfileForm.subtitle.personalInfo':
    'Cuéntanos brevemente sobre tu experiencia para que los clientes te conozcan.',
  'coachProfileForm.subtitle.trainingDetails': 'Selecciona los estilos que entrenas y dinos dónde trabajas.',
  'coachProfileForm.subtitle.subscription': 'Elige cómo quieres comenzar a usar EaseTrain.',
  'coachProfileForm.subtitle.confirmation': 'Verifica cada detalle antes de publicar tu perfil.',
  'coachProfileForm.helper.training': 'Destaca 2 o 3 especialidades',
  'coachProfileForm.helper.freeTrial': 'Comienza gratis e incorpora hasta tres clientes.',
  'coachProfileForm.helper.paid': 'Desbloquea pagos, automatización y analíticas avanzadas.',
  'coachProfileForm.placeholder.pending': 'Pendiente',
  'coachProfileForm.placeholder.name': 'Ej.: Alex López',
  'coachProfileForm.placeholder.bio': 'Comparte tu filosofía, certificaciones o logros.',
  'coachProfileForm.placeholder.experience': 'Años de experiencia, equipos o hitos relevantes.',
  'coachProfileForm.placeholder.gymLocation': 'Ciudad, barrio o nombre del estudio',
  'coachProfileForm.plan.notSelected': 'Aún no seleccionaste un plan',
  'coachProfileForm.plan.cta': 'Seleccionar plan',
  'coachProfileForm.validation.name': 'El nombre es obligatorio.',
  'coachProfileForm.validation.bio': 'La biografía es obligatoria.',
  'coachProfileForm.validation.experience': 'La experiencia es obligatoria.',
  'coachProfileForm.validation.trainingType': 'Selecciona al menos una especialidad.',
  'coachProfileForm.validation.gymLocation': 'Ingresa la ubicación del gimnasio.',
  ...
  'verification.error.codeRequired': 'Ingresa el código de verificación antes de continuar',
  ...
  'exercises.import.duplicatesInFile.title':
    'Se encontraron ejercicios con nombres duplicados en el archivo. Por favor corregí el archivo Excel y volvé a importarlo.',
  'exercises.import.duplicatesInFile.rows': 'filas {rows}',
  'exercises.import.previewVideo': 'Ver video',
