...
import { IRpeMethod } from 'types/shared-types';
...
export default function NewWorkoutTable({
  ...
  const customModifier = ({
    ...
    return restrictToVerticalAxis({ transform, draggingNodeRect, overlayNodeRect } as any);
  };
   ...
   ****************************************/
  const handleAddExerciseAtPosition = (index?: number) => {
    if (!isEditing) return;
  ...
  const handleAddGroup = (index?: number, isNew = false) => {
    if (!isEditing) return;
        ...
        {!isEditing ? (
          ...
          <div className="flex justify-content-between">
            <div className="flex align-items-center justify-content-between gap-1">
              ...
              <button className="p-button p-component p-button-secondary" onClick={() => handleAddGroup()}>
                <FaPlus className="mr-2" />
