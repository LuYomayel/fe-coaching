...
const OfflineIndicator = () => {
  // Inicializar con true para SSR (asumimos online por defecto)
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && typeof navigator !== 'undefined') {
      // Establecer el estado real de la conexión
  ...
  // No renderizar nada durante SSR o hasta que el cliente esté listo
