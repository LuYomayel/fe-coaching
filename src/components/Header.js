...
import { ChatSidebarProvider, useChatSidebar } from '../utils/ChatSideBarContext';
...
export default function Header() {
  ...
  return (
    <div className="flex justify-content-between align-items-center p-3 surface-0 shadow-1">
      ...
      <div className="flex align-items-center">
        <Button icon="pi pi-comments" onClick={openChatSidebar} className="p-button-text mr-2" label="Chat"  badge={unreadMessages > 0 ? unreadMessages : null}  />
        <Button
          icon="pi pi-bell"
