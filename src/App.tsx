...
const AppContent: React.FC<AppContentProps> = ({ sidebarExpanded, setSidebarExpanded, isMobile }) => {
    ...
    <div className="flex">
      ...
      >
        <Routes>
          ...
          />
          <Route path="/student/calendar" element={<PrivateRoute element={StudentCalendar} requiredType="client" />} />

          <Route path="/verify-email" element={<VerifyEmail />} />
          <Route
            path="/complete-coach-profile"
            element={<PrivateRoute element={CoachProfileForm} requiredType="coach" />}
          />
